...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { { X_CENTER, Y_CENTER }, { 45, 45 }, { 190, 45 }, { 190, 190 }, { 45, 190 }  }
...
// This line is unique to Creality V4.2.2 board where it
// uses 24V MOSFET powered PA0 pin for ether LASER_FEATURE or Part Cooler
// FAN with M106 sync enabled.  This logic can be used with other similar
// board but must list correct FAN pin.
//#define LASER_FEATURE
// Enable personal debug statement to help find PWM issues
// in LASER_FEATURE code paths.
#define LASER_PWM_DEBUG
...
#define LASER_SYNCHRONOUS_M106_M107
  ...
  #define SPINDLE_LASER_USE_PWM                // Enable if your controller supports setting the speed/power
    ...
    // Changing to align with part cooler fan default since its shared.
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
    ...
    */
    ...
    // Disable so laser can be focused using 1% power.
