...
// @section bltouch
  ...
  #define BLTOUCH_HS_MODE true
    ...
    // 3 is based on probe offset ~2.4
...
#define ASSISTED_TRAMMING
  ...
  //
  // Simple approach: Put probe on top of a screw when possible except
  // for Y backside where its not possible.  In that case, put it as close
  // as possible.
  //
  // Screws are located {30,30} offset from each corner.
  // x_probe_max: 259-32=227 y_probe_max: 223-41.5=181.5
  //
  // x min is (0+30) = 30
  // y min is (0+30) = 30
  // x max is (235-30) = min(205,227)
  // y max is (235-30) = min(205,181.5)
  #define TRAMMING_POINT_XY { { 30, 30 }, { 205, 30}, { 205, 181.5 }, { 30, 181.5 }  }
...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  38.0        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  44.0        // (Hz) The default dominant resonant frequency on the Y axis.
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD
    ...
    #define X_AXIS_TWIST_COMPENSATION
      ...
      #define XATC_Z_OFFSETS { 0.13, -0.07, -0.07 }    // Z offsets for X axis sample points
    #endif
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    // I replaced X stepper with original E stepper
...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_CURRENT   (Z_CURRENT/1.6)// Default calibration current in ma
  #define GANTRY_CALIBRATION_EXTRA_HEIGHT      12     // Extra distance in mm past Z_###_POS to move
  #define GANTRY_CALIBRATION_FEEDRATE         500     // Feedrate for correction move
  //#define GANTRY_CALIBRATION_TO_MIN                 // Enable to calibrate Z in the MIN direction

  #define GANTRY_CALIBRATION_SAFE_POSITION XY_CENTER // Safe position for nozzle
  #define GANTRY_CALIBRATION_XY_PARK_FEEDRATE   400  // XY Park Feedrate - MMM
