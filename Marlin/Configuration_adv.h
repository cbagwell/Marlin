...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { { X_CENTER, Y_CENTER }, { 41.5, 41.5 }, { 189.5, 41.5}, { 189.5, 189.5 }, { 41.5, 189.5 }  }
...
//#define FT_MOTION
  ...
  #define FTM_SHAPING_DEFAULT_X_FREQ 38.0f              // (Hz) Default peak frequency used by input shapers.
  #define FTM_SHAPING_DEFAULT_Y_FREQ 44.0f              // (Hz) Default peak frequency used by input shapers.
...
#define MECHANICAL_GANTRY_CALIBRATION
  ...
  #define GANTRY_CALIBRATION_CURRENT   (Z_CURRENT/2.4)// Default calibration current in ma
  #define GANTRY_CALIBRATION_EXTRA_HEIGHT       9     // Extra distance in mm past Z_###_POS to move
