...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro SKR Mini E3 BLTouch"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  26.81,  26.81 }
    #define DEFAULT_Ki_LIST {   2.28,   2.28 }
    #define DEFAULT_Kd_LIST {  78.82,  78.82 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 183.58
  #define DEFAULT_bedKi 34.25
  #define DEFAULT_bedKd 656.04
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.10, 80.30, 399.60, 139 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 200, 2500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -7, -1.15 }
