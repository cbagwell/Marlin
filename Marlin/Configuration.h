...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro V422 BLTouch"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ender 3 v2
    ...
    #define DEFAULT_Kp_LIST {  29.10,  29.10 }
    #define DEFAULT_Ki_LIST {   2.71,   2.71 }
    #define DEFAULT_Kd_LIST {  78.00,  78.00kkjk
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 284.80
  #define DEFAULT_bedKi 55.62
  #define DEFAULT_bedKd 972.10
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.10, 80.30, 399.60, 93 }
